...
const ContactoBrota= ({titulo, mail, telefono, linkRedes, facebook}) => {
    return (
        <div className="container mt-2">
            <Card className="card-contacto card-m mb-6">
                ...
                <Card.Body>
                    ...
                    <Card.Text  className="text-center"><BsFillTelephoneFill className="card-icon" /> Comunicate con nosotros al siguiente celular: <span className='tel-m'>{telefono}</span></Card.Text>
